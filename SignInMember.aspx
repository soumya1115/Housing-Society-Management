<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignInMember.aspx.cs" Inherits="SignInMember" %>
...
<section id="header">
        ...
        <div class="home">
           ...
           <li><a  href="SignInAdmin.aspx">Admin SignIn</a></li>
                <li class="active"><a  href="SignInMember.aspx"> Member SignIn</a> </li>
            </ul>
        </div>
    </section>
        ...
        <div style="margin-left:350px; margin-top:0px;" class="auto-style1">
          <h3 style="text-align:center; background-color:lightgreen; padding:5px;"> Member Login </h3>
        ...
        <div class="container" style="background-color:#f1f1f1;">
            <asp:Button ID="Button2" runat="server" Text="Clear" BackColor="Red" Height="39px" Width="85px" />
            <asp:HyperLink ID="HyperLink1" runat="server" style="padding:0 0 0 1000px; font-size:large; font-weight:bold;"  NavigateUrl="~/AdminLogin.aspx">Back </asp:HyperLink>
            </div>
        <br />
        <div style="padding:0 200px 0 150px; font-size:large; font-weight:bold;">
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/forgotPasswordMem.aspx">Forgot Password?</asp:HyperLink>
            </div>
