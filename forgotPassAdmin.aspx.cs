...
public partial class forgotPassAdmin : System.Web.UI.Page
{
    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from tbladmin where Email=@Email", con);
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi," +Username + ", <br/><br/> Click the link below to reset your password <br/> http://localhost:56031/RecoverPassword.aspx?id="+myGuid ;
